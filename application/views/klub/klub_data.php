            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="pull-left">
                            <a href="<?= base_url('klub/add') ?>" class="btn btn-primary btn-flat">
                            ...
                            <tbody>
                                ...
                                foreach ($row->result() as $key => $data) : ?>
                                    <tr>
                                        ...
                                        <td><?= $data->email ?></td>
                                        <td><?= $data->kontak ?></td>
                                        <td><img width="40" height="40" class="img-circle" src="<?= base_url('uploads/logo_klub/') . $data->logo; ?>"></td>
                                        <td>
                                            <a href="<?= base_url('klub/edit/' . $data->id_klub) ?>" class="btn btn-info btn-xs">
                                                <i class="fa fa-pencil"></i>Update
                                            </a>
                                            <a href="<?= base_url('klub/delete/' . $data->id_klub) ?>" onclick="return confirm('Apakah anda yakin hapus data ini?')" class="btn btn-danger btn-xs">

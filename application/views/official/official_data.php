            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="pull-left">
                            <a href="<?= base_url('official/add') ?>" class="btn btn-primary btn-flat">
                        ...
                        <table class="table table-bordered table-striped" id="table1">
                            ...
                            <tbody>
                                ...
                                foreach ($row->result() as $key => $data) : ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><img width="40" height="40" class="img-circle" src="<?= base_url('uploads/photo_official/') . $data->photo; ?>"></td>
                                        <td><?= $data->nama ?></td>
                                        ...
                                        <td><?= $data->posisi ?></td>
                                        <td>
                                            <a href="<?= base_url('official/edit/' . $data->id_official) ?>" class="btn btn-info btn-xs">
                                                <i class="fa fa-pencil"></i>Update
                                            </a>
                                            <a href="<?= base_url('official/delete/' . $data->id_official) ?>" onclick="return confirm('Apakah anda yakin hapus data ini?')" class="btn btn-danger btn-xs">
